...
const LAZY_ENV = () => {
  ...
  return Object.freeze({
    ...
    INLINED_SOCKET_CLI_COANA_TECH_CLI_VERSION: envAsString("15.6.6"),
    ...
    INLINED_SOCKET_CLI_VERSION: envAsString("1.1.132"),
    // Comp-time inlined Socket package version hash.
    // The '@rollup/plugin-replace' will replace "process.env['INLINED_SOCKET_CLI_VERSION_HASH']".
    INLINED_SOCKET_CLI_VERSION_HASH: envAsString("1.1.132:48c4d3f:97f30f30"),
...
//# debugId=d40385e3-25be-4219-a615-2646dcb7f3a0
